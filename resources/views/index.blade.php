...
<head>
  ...
  <!-- slider stylesheet -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" integrity="sha384-GLhlTQ8iN17Et3fZl/rANTLWIuKlqDlV1d83S9FZnHQG8AdzLIYGXJudK2M" crossorigin="anonymous">
...
<body>
  ...
  <section class="info_section  layout_padding2-top">
    ...
    <footer class=" footer_section">
      <div class="container">
        <p>
          &copy; <span id="displayYear"></span> All Rights Reserved By Faizal khan
        </p>
      </div>
    </footer>
    <!-- footer section -->
